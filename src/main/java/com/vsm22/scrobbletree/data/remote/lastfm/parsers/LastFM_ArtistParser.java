...
public class LastFM_ArtistParser {
	
	public static LastFM_Artist parse(Element artistElement) {	
		...
		List<LastFM_Artist> similarArtists = (similarArtistsElement != null) ? LastFM_ArtistListParser.parse(similarArtistsElement) : null;
		List<LastFM_Tag> tagList = (tagsElement != null) ? LastFM_TagListParser.parse(tagsElement) : null;
		LastFM_Bio bio = (bioElement != null) ? LastFM_BioParser.parse(bioElement) : null;
		...
		LastFM_Artist newArtist = new LastFM_Artist(newArtistConstructorArgs);
